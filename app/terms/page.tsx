...
export const metadata: Metadata = {
  title: 'Terms of Service & Disclosures — The Daily Reset',
}
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: green.pale, color: text.dark, lineHeight: 1.7, fontSize: 15 }}>
      ...
      <header style={{ background: `linear-gradient(135deg, ${green.dark} 0%, ${green.primary} 60%, ${green.accent} 100%)`, padding: '48px 32px 40px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.65)', maxWidth: 500, margin: '0 auto' }}>The Daily Reset — Independent Coach Business Management Platform</p>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div id="independence" style={{ background: 'linear-gradient(135deg, #F4FAF6 0%, #E8F5E9 100%)', border: `2px solid ${green.primary}`, borderRadius: 14, padding: '36px 36px 32px', marginBottom: 24, position: 'relative' }}>
          ...
          <p style={pStyle}><strong style={{ color: text.dark }}>This application ("The Daily Reset," "the App," "the Platform," or "the Service") is an independently created, privately operated business management tool.</strong> It is designed to assist individual OPTAVIA health coaches in organizing their personal coaching practices.</p>
        ...
        <SectionBlock id="acceptance" num="03" title="Acceptance of Terms">
          <p style={pStyle}>By accessing or using The Daily Reset platform, you (&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;) agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, you may not access or use the Service.</p>
          ...
          <p style={pStyle}>These Terms constitute a legally binding agreement between you and the operator of The Daily Reset (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).</p>
        </SectionBlock>

        {/* Section 4: Description */}
        <SectionBlock id="description" num="04" title="Description of Service">
          <p style={pStyle}>The Daily Reset is an independent, privately operated business management platform designed to help OPTAVIA health coaches organize and manage their coaching practice. The Service may include, but is not limited to:</p>
          <ul style={ulStyle}>
        ...
        <SectionBlock id="contact" num="12" title="Contact Information">
          ...
          <HighlightBox>
            <strong style={{ color: green.dark }}>The Daily Reset</strong><br />
      ...
      <footer style={{ textAlign: 'center', padding: '32px 24px', borderTop: `1px solid ${border}`, marginTop: 40 }}>
        <p style={{ fontSize: 11.5, color: text.muted, maxWidth: 620, margin: '0 auto 8px' }}>© 2026 Rogers Optimal Health / The Daily Reset. All rights reserved.</p>
